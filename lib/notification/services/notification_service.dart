...
class NotificationService {
  ...
  _initializeNotifications() async {
    ...
    final iOS = IOSInitializationSettings(
      ...
      onDidReceiveLocalNotification: _onDidReceiveLocalNotification, // Função de callback não pode ser const
    );
    ...
    await localNotificationsPlugin.initialize(
      ...
      onSelectNotification: _onSelectNotification, // Callback para quando a notificação for clicada
    );
  }

  // Apenas para iOS: Esta função é chamada quando uma notificação local é recebida enquanto o app está no foreground
