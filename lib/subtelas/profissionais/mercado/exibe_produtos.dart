...
class _ProdutosDistribuidoresState extends State<ProdutosDistribuidores> {
  ...
  List<DocumentSnapshot> _products = []; // Lista para armazenar os produtos
  ...
  void initState() {
    super.initState();
    fetchFilters();
    fetchProducts(); // Chamando o fetchProducts no initState
  }
  ...
  Future<void> fetchProducts() async {
    ...
    setState(() {
      _products = produtosSnapshot.docs; // Armazena os produtos carregados
      ...
      body: _isLoading
          ...
          : ListView(
              ...
              children: [
                ...
                // Lista de produtos
                _buildProductsList(crossAxisCount),
              ],
            ),
    );
  }
  
  Widget _buildProductsList(int crossAxisCount) {
    // Filtragem e ordenação dos produtos
    var filteredProducts = _products.where((doc) {
      ...
      final matchesBrand =
          _selectedBrand == 'Todos' || productBrand == _selectedBrand.toLowerCase();
